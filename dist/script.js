...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_validate_js__WEBPACK_IMPORTED_MODULE_5__["default"])();
  Object(_modules_timer_js__WEBPACK_IMPORTED_MODULE_6__["default"])('.container1', deadline);
  Object(_modules_gallery_js__WEBPACK_IMPORTED_MODULE_7__["default"])('.preview');
});
...
var gallery = function gallery(triggerSelector) {
...
var modals = function modals() {
  function bindModal(triggersSelector, modalSelector, btnCloseSelector) {
    ...
    var allModalSelector = arguments.length > 4 ? arguments[4] : undefined;
    ...
    triggers.forEach(function (item) {
      item.addEventListener('click', function (e) {
        ...
        if (e.target) {
          allModals.forEach(function (elem) {
  ...
  bindModal('.popup_calc_profile_button', '.popup_calc_end', '.popup_calc_end_close', false, '[data-modal]'); // showModalByTime('.popup', 60000);
};
...
/* harmony default export */ __webpack_exports__["default"] = (jquery__WEBPACK_IMPORTED_MODULE_0___default()('.glazing_slider').slick({
  infinite: true,
  slidesToShow: 5,
  slidesToScroll: 1,
  responsive: [{
...
var validate = function validate() {
  function validation(selector, buttonSelector) {
    ...
    inputs.forEach(function (item) {
      if (inputs.type === 'text') {
        var button = item.parentElement.querySelector(buttonSelector);
        button.setAttribute('disabled', 'disabled');
        item.addEventListener('input', function () {
          item.value = item.value.replace(/\D/, '');
          var allInputs = item.parentElement.querySelectorAll('.form-control');
        ...
        var _button = item.parentElement.parentElement.querySelector(buttonSelector);
